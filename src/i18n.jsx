...
const resources = {
	ua: {
		translation: {
			...
			'personal.info-description__3': '28 років',
			...
			'portfolio.item3-desc': 'Онлайн-магазин',
			'portfolio.item4-desc': 'Трекер завдань',
			'portfolio.item5-desc': 'React додаток',
			'portfolio.item6-desc': 'Генератор кредиток',
			'portfolio.item7-desc': 'Верстка',
			'portfolio.item9-desc': 'Генератор кольорів',
			'portfolio.item10-desc': 'Лендінг + кабінет',
			'portfolio.item13-desc': 'Вебсайт',
			'portfolio.item14-desc': 'Онлайн-школа',
			'portfolio.item17-desc': 'Онлайн-гра',
			'portfolio.item20-desc': 'Калькулятор',
	...
	en: {
		translation: {
			...
			'personal.info-description__3': '28 Years',
